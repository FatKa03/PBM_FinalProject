...
class DaftarkanMobil extends StatefulWidget {
  const DaftarkanMobil({Key? key}) : super(key: key);

  @override
  State<DaftarkanMobil> createState() => _DaftarkanMobilState();
}

class _DaftarkanMobilState extends State<DaftarkanMobil> {
