...
class Order extends StatefulWidget {
  ...
  Order(this.Alamat, this.Deskripsi, this.FotoMobil, this.Harga,
      this.TipeMobil, this.NamaToko, this.ProfilPict,
      {Key? key})
      : super(key: key);
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text(
                                    'Mobilnya sangat nyaman, harga sewanya murah',
                                    style: TextStyle(
                ...
                children: [
                  ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        primary: Color.fromARGB(245, 252, 204, 30),
                        textStyle: const TextStyle(
                          fontSize: 16,
                        ),
                      )),
